...
describe("Get /api/add-student-team-schoolterm", () => {
    it("get all school term data", (done) => {
        chai.request(server)
        .get("/api/add-student-team-schoolterm")
        .end((err, response) => {
            expect(response).to.have.status(200);
            expect(response).to.be.an('object');
        done();
...
describe("Get /add-student-team-coursecode", () => {
    it("get all school term data", (done) => {
        chai.request(server)
        .get("/api/add-student-team-coursecode")
        .end((err, response) => {
            expect(response).to.have.status(200);
            expect(response).to.be.an('object');
        done();
    ...
    describe("Get /project-list-by-project-status", () => {
        it("get all project list by project status", (done) => {
            chai.request(server)
            .get("/api/project-list-by-project-status/?projectStatus=123")
            .end((err, response) => {
                expect(response).to.have.status(200);
                expect(response).to.be.an('object');
            done();
    ...
    describe("Get /project-team-application-status", () => {
        it("get application status to project", async () => {
            chai.request(server)
            .get("/api/project-team-application-status/?projectId=1&teamId=1")
            .end((err, response) => {
                expect(response).to.have.status(200);
                expect(response).to.be.an('object');
            //done();
...
/////////////////////////////////////Get with id
    ...
    describe("Get /add-student-team-all-student-per-team/:id", () => {
        it("it should get a user by id", async() => {
            const id = 1;
            chai.request(server)
            .get("/api/add-student-team-all-student-per-team/:id" + id)
            .end((err, response) => {
                expect(response).to.have.status(200);
                // expect(response).to.be.an('object');
                //done();
    ...
    describe("Get /application-by-team/:teamId", () => {
        it("application-by-team/:teamId", async () => {
            const teamId = 1;
            chai.request(server)
            .get("/api/application-by-team/:teamId" + teamId)
            .end((err, response) => {
                expect(response).to.have.status(200);
                // expect(response).to.be.an('object');
            //done();
    ...
    describe("Get /project-all-applied-teams/:id", () => {
        it("get all applied teams per project data", (done) => {
            const gID = 1;
            chai.request(server)
            .get("/api/project-all-applied-teams/:id" + gID)
            .end((err, response) => {
                expect(response).to.have.status(200);
                // expect(response).to.be.an('object');
            done();
    ...
    describe("Get /add-student-team-teamData/:id", () => {
        it("get team data", (done) => {
            const gID = 1;
            chai.request(server)
            .get("/api/add-student-team-teamData/:id" + gID)
            .end((err, response) => {
                expect(response).to.have.status(200);
                // expect(response).to.be.an('object');
            done();
    ...
    describe("Post /add-student-team-to-student", () => {
        it("update student data with team name", (done) => {
            chai.request(server)
            .post("/api/add-student-team-to-student")
    ...
    describe("Delete /project-update-selected-team/:id", () => {
        it("update selected project", (done) => {
            const id = 1;
            chai.request(server)
            .delete("/api/project-update-selected-team/:id" + id)
            .end((err, response) => {
                expect(response).to.have.status(200);
                // expect(response).to.be.an('object');
            done();
        ...
        describe("Delete /project-cancel-selected-team/:id", () => {
            it("update selected project as cancel", (done) => {
                const id = 1;
                chai.request(server)
                .delete("/api/project-cancel-selected-team/:id" + id)
                .end((err, response) => {
                    expect(response).to.have.status(200);
                    // expect(response).to.be.an('object');
                done();
